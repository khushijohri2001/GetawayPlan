    ...
    <div>
        ...
        <div>
            ...
            <div className='flex flex-wrap gap-6'>
              {
                allDestinationData && allDestinationData.length > 0 && allDestinationData.map((destination) => <DestinationCard key={destination._id} route={categoryId} data={destination} />)
              }
            </div>
        </div>
    </div>
